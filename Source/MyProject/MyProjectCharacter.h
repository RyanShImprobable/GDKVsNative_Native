...
public:
	...
	UFUNCTION(Server, Reliable, WithValidation)
		void ServerInteract_S2C_VarRep(const FString& s);

	void Execute();

	UFUNCTION(Client, Reliable)
	void NotifyClientRoundTripDone(const int& s1, const int& s2);
...
private:
		...
		void Initializing_TT_REPLICATION_ROUNDTRIP_Env();
		UFUNCTION(Server, Reliable, WithValidation)
		void ServerInitializing_TT_REPLICATION_ROUNDTRIP_Env(const FServerInitData& data);
